...
namespace MAXSharp
{
	public class MAXMonitoringThread
	{
		...
		private double ELVMAXSensorReStoringSec = 360;
		private Int32 ELVMAXReconnectTimeMsec = 60000;
		public bool connected = false;

		public MAXMonitoringThread(String _Hostname, Int32 _Port, ConcurrentQueue<IDeviceDiffSet> EventQueue, Int32 UpdateTime = 10000)
		{
			Hostname = _Hostname;
			Port = _Port;
